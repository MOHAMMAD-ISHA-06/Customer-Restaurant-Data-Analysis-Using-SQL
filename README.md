...
**Tables:** - **consumers(consumer_id, age, gender, occupation, smoker,
city)** - **restaurants(restaurant_id, name, city, price_range)** -
**ratings(rating_id, consumer_id, restaurant_id, food_rating,
service_rating, overall_rating)** - **restaurant_cuisines(id,
restaurant_id, cuisine)**

**Relationships:** - One consumer ➝ Many ratings\
